...
namespace Dashboard_DI04.DsTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Dashboard_DI04.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        public virtual int Fill(Ds.CustomersDataTable dataTable, string Param1) {
        ...
        public virtual Ds.CustomersDataTable GetData(string Param1) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((Param1 == null)) {
                throw new global::System.ArgumentNullException("Param1");
            }
